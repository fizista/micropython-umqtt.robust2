...
setuptools.setup(
    ...
    url='https://github.com/fizista/micropython-umqtt.robust2',
    author='Wojciech Banaś',
    author_email='fizista@gmail.com',
    maintainer='Wojciech Banaś',
    maintainer_email='fizista+umqtt.robust2@gmail.com',
    license='MIT',
    classifiers=[
    ...
    project_urls={
        'Bug Reports': 'https://github.com/fizista/micropython-umqtt.robust2/issues',
        'Source': 'https://github.com/fizista/micropython-umqtt.robust2',
    },
)
